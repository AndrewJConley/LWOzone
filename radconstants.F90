...
integer, public, parameter :: pcols = 1
integer, public, parameter :: ncol = 1
integer, public, parameter :: lchnk = 1
integer, public, parameter :: pver = 63
integer, public, parameter :: pverp = 64

integer, public, parameter :: rrtmg_levs = 63
...
integer, parameter, public :: ozone_band = 7
